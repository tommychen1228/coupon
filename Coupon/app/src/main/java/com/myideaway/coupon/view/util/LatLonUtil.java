package com.myideaway.coupon.view.util;
...
public class LatLonUtil {
    ...
    public static final int LAT_BOTTOM = 0;
    public static final int LNG_LEFT = 1;
    public static final int LAT_TOP = 2;
    public static final int LNG_RIGHT = 3;
