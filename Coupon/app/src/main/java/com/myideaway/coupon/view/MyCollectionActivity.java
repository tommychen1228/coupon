...
import com.myideaway.coupon.model.coupon.service.biz.CouponBSGetCollectData;
...
public class MyCollectionActivity extends BaseActivity {
    ...
    private void initCouponListView(final boolean isLock) {
        ...
        boolean isSubmit = applicationContext.isLogin(MyCollectionActivity.this, true);
        if (isSubmit) {
            User user = applicationContext.getUser(MyCollectionActivity.this);
            CouponBSGetCollectData couponBSGetCollectData = new CouponBSGetCollectData(this);
            couponBSGetCollectData.setEmail(user.getEmail());
            couponBSGetCollectData.setPassword(user.getPassword());
            couponBSGetCollectData.setPage(page);
            couponBSGetCollectData.asyncExecute();
            couponBSGetCollectData.setOnSuccessHandler(new Service.OnSuccessHandler() {
                @Override
                public void onSuccess(Service service, Object o) {
                    couponListView.onRefreshComplete();
                    CouponBSGetCollectData.CouponBSGetCollectDataResult couponBSGetCollectDataResult = (CouponBSGetCollectData.CouponBSGetCollectDataResult) o;
                    couponList = couponBSGetCollectDataResult.getCouponList();
                    couponListView.setAdapter(couponAdapter);
                    if (isLock) {
                        hideProgressDialog();
                    }
            ...
            couponBSGetCollectData.setOnFaultHandler(new Service.OnFaultHandler() {
                @Override
        ...
        if (isSubmit) {
            ...
            couponBSGetCollectData.setOnSuccessHandler(new Service.OnSuccessHandler() {
                ...
                public void onSuccess(Service service, Object o) {
                    couponListView.onRefreshComplete();
                    CouponBSGetCollectData.CouponBSGetCollectDataResult couponBSGetCollectDataResult = (CouponBSGetCollectData.CouponBSGetCollectDataResult) o;
                    if (page > Integer.parseInt(couponBSGetCollectDataResult.getPageTotal())) {
                       showNoMoreDataToast();
                        MyCollectionActivity.this.page--;
                    } else {
                        couponList.addAll(couponBSGetCollectDataResult.getCouponList());
    ...
    private class CouponAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View couponView, ViewGroup parent) {
            ...
            couponView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(MyCollectionActivity.this, CouponDetailActivity.class);
